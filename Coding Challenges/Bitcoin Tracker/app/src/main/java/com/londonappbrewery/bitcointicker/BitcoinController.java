...
public class BitcoinController extends AppCompatActivity {
    ...
    private final String KEY = "xxx____YOUR_API_KEY_GOES_THERE___xxx";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                Log.d("Bitcoin", "Item at position: "+  adapterView.getItemAtPosition(i));
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try {
                    ...
                    Log.d("Bitcoin", "Request success!");
                    Log.d("Bitcoin", "JSON: " + jsonResponse.toString());
                    BitcoinDataModel bitcoinData = BitcoinDataModel.fromJson(jsonResponse);
    ...
    private void updateUI(BitcoinDataModel bitcoinData){
        mPriceTextView.setText(Double.toString(bitcoinData.getLastCurrency()));
    }
